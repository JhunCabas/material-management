...
$(function (){
	...
	$("li#save").click(function (){
		 ...
		 $.post("parser/Supplier.php",{type: "edit", key: key, name: name, address: address, contact_person: person, contact: contact, info:info},
		 function (data){
		 	if(data != "")
			 {
				 $("#dialogBox").html(data);
	...
	$("li#add").click(function (){
		 ...
		 if(confirm("Continue?"))
			$.post("parser/Supplier.php",{type: "add", name: name, address: address, contact: contact, contact_person: person, info: info},function (data){
		 		if(data != "")
				 {
				 	 $("#dialogBox").html(data);
					 $("#dialogBox").dialog('option', 'title', 'Error');
					...
					$("#dialogBox").dialog('option', 'title', 'Success');
					$("#dialogBox").dialog('open');
					var prependedText = "<tr><td>"+name+"</td><td>"+address+"</td><td>"+person+"</td><td>"+contact+"</td><td>"+info+"</td></tr>";
