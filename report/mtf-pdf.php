...
$pdf->Text(135,32,"MATERIAL TRANSFER FORM");
...
$pdf->Text(10,36,"".$pbranchAdd[1]);
$pdf->Text(10,40,"".$pbranchAdd[2].", ".$pbranchAdd[3]);     
      
$pdf->Text(10,46,"To Branch : ".$branch_to);


$pdf->Text(135,37,"MTF No: ".$MTFnum);
$pdf->Text(135,46,"Doc Date: ".$date);



$pdf->SetFont('Arial','B',9);
$pdf->Text(12,235,"Issued By : ");
$pdf->Text(135,235,"Received  By : ");
...
$pdf->Text(10,36,"".$pbranchAdd[1]);
$pdf->Text(10,39,"".$pbranchAdd[2].", ".$pbranchAdd[3]);      
      
$pdf->Text(10,42,"To Branch : ".$branch_to);


$pdf->Text(135,37,"MTF No: ".$MTFnum);
$pdf->Text(135,42,"Doc Date: ".$date);
